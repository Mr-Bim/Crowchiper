...
test.describe("Nested posts - Expand/Collapse", () => {
  ...
  test("can expand and collapse nested posts", async () => {
    ...
    const expandBtn = parentPost.locator(".post-expand-btn");
  ...
  test("deeply nested posts are expandable", async () => {
    ...
    const level1ExpandBtn = level1.locator(".post-expand-btn");
    const level2ExpandBtn = level2.locator(".post-expand-btn");
    ...
    const level2ExpandBtnAgain = level2Visible.locator(".post-expand-btn");
