...
/**
 * Clean up pending upload placeholders from content.
 * Removes galleries that only contain pending/converting images.
 * Used when loading posts to clean up interrupted uploads.
 */
